...
values."
  (setq-default
   ...
   ;; used pacemacs.dackages but won't delete them if they become unused. `all' will
...
values."
  ...
  (if (eq system-type 'windows-nt)
      (setq-default dotspacemacs-emacs-leader-key "<apps>")
    (setq-default dotspacemacs-emacs-leader-key "<menu>"))
  (setq-default
